            ...
            public void onComplete(Message msg) {
                ...
                if (msg.getData().containsKey(TaskKey.ERROR_MSG)) {
                    ...
                    if (response.getResponseCode().equalsIgnoreCase("00")) {
                        ...
                        try {
                            MyData myData = ModelProvider.getMyDataAutoSync(AutoSyncService.this, new MyData(), response);
                            ModelHandler.getInstance(AutoSyncService.this).handleMydataSync(myData);
...
//		}
    ...
    public IBinder onBind(Intent arg0) {
        ...
        startSync();
        saveCurrentStockToStockHisotory();
...
//        intent.putExtra("NOTIF_ID", 9999);
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    mBuilder =
                            new NotificationCompat.Builder(this, channelId)
                                    ...
                                    .setContentIntent(PendingIntent.getActivity(this, 0, new Intent(), PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE))
                                    .setDefaults(0)
                                    .setAutoCancel(true);
                } else {
                    mBuilder =
    ...
    public void saveCurrentStockToStockHisotory() {
        JSONArray configArry = AppPreference.getFCMConfigration(this);
        try {
