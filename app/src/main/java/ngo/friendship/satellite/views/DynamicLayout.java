...
public class DynamicLayout extends ViewGroup {
    ...
    public DynamicLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray styledAttributes = context.obtainStyledAttributes(attrs, R.styleable.DynamicLayout);
        horizontalSpacing = styledAttributes.getDimensionPixelSize(R.styleable.DynamicLayout_android_horizontalSpacing, DEFAULT_HORIZONTAL_SPACING);
        verticalSpacing = styledAttributes.getDimensionPixelSize(R.styleable.DynamicLayout_android_verticalSpacing, DEFAULT_VERTICAL_SPACING);
