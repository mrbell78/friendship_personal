...
/**
 * The Class Next30DaysTimeScheduleListActivity.
 */
public class Next30DaysTimeScheduleListActivity extends AppCompatActivity implements OnClickListener,OnCompleteListener{
	...
	protected void onResume() {
		...
		activityPath=Utility.setActivityPath(this, R.string.next_7_days_time_schedule);
	...
	private void showData(ArrayList<UserScheduleInfo> scheduleList)
	{
		...
		for(UserScheduleInfo schedInfo : scheduleList)
		{
			if(dateStr == null || !dateStr.equalsIgnoreCase(schedInfo.getScheduleDateStr()))
			{
				...
				tv.setBackgroundColor(Color.rgb(87, 87, 87));
