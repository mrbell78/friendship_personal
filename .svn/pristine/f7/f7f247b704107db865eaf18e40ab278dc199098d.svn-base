 ...
 */
public abstract class PaginatedAdapterData<ITEM, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public void submitItemAll(Collection<? extends ITEM> collection) {
        try {
            clear();
            mDataSet.addAll(collection);
            notifyDataSetChanged();
